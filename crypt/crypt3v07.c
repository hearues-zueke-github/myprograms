...
void switchD1Increment(uchar dim, uchar matrix[MS][MS][MS][MS],
  ...
  for (loopm = 0; loopm < multiplier; loopm++)
  {
    ...
    if (direction == 0)
    {
      ...
      for (loop1 = 0; loop1 < MS; loop1++)
      {
        ...
        switchD1Increment(dim1, matrix, row1, row2, row3, loop1, value_temp2);
        /*switch (dim1)
        {
    ...
    else if (direction == 1)
    {
      ...
      for (loop1 = MS; loop1 > 0; loop1--)
      {
        ...
        switchD1Increment(dim1, matrix, row1, row2, row3, loop1 - 1, value_temp2);
      }
      // 2nd Dimension
      for (loop1 = MS; loop1 > 0; loop1--)
      {
